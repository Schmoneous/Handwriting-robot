...
cal.flip_x = False  # disabled just for this readability check
...
# no invert_yaxis this time -- checking natural orientation
plt.axis('equal')
plt.savefig('preview3.png')
print('saved preview3.png')